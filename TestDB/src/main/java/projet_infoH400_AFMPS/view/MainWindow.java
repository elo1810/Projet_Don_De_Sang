...
public class MainWindow extends javax.swing.JFrame {
    ...
    /*
        Fonction qui mets à jour l'affichage du contenu de la base de données 
    ...
    */
    ...
    /*
        ...
        On récupère les informations venant de l'interface 
        - HL7 host 
        - HL7 port 
        Ces informations sont entrées par l'utilisateur quand il ouvre le popup
        On récupère aussi les informations à propos du groupe de sang sur lequel on clique, 
        pour lequel on souhaite envoyer une alerte.
        Ensuite, on crée le message et on l'envoit 
